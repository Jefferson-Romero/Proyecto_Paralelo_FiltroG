//Autores Boris Ruano - Michael Robles - Bryan Chacon
...
using namespace std;
   ...
   vector<vector<int>> newMatriz(DicomReader dicomObj){
        ...
        vector<vector<int>> data1 = dicomObj.getIntImageMatrix(12);
        vector<vector<int>> data2 = dicomObj.getIntImageMatrix(12);
        vector<vector<int>> data3 = dicomObj.getIntImageMatrix(12);
        vector<vector<int>> data4 = dicomObj.getIntImageMatrix(12); //guarda la matriz de la img dicom
        return data;
   }
   ...
   // de imagen clonada
    vector<vector<int>> claheGo(vector<vector<int>> CLAHE_GO,vector<vector<int>> data,DicomReader dicomObj){
        ...
        dicomObj.saveData(CLAHE_GO,"/home/boris/Documentos/DicomClaheH2/csvC/MasaMicroC1.csv",",",false);
        return CLAHE_GO;
